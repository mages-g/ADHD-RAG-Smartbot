...
if "messages" not in st.session_state:
    st.session_state.messages = [
        {"role": "assistant", "content": "Hello! I'm your ADHD assistant. I can answer questions based only on the uploaded psychiatric PDF documents. My knowledge is limited to the information contained in these documents. How can I help you today?"}
    ]
...
st.title("ADHD SmartBot")
st.markdown("**Your trusted psychiatric knowledge assistant powered by local documents and AI**")
st.markdown("This chatbot answers psychiatric questions based **only** on the uploaded psychiatric PDF documents. The answers are limited to the information contained in these documents. Ask any psychiatric question to get started.")
st.markdown("<div style='font-size: 0.8rem; margin-top: 0.5rem;'>Created by <a href='https://github.com/g-mages' target='_blank'>mages-g</a> | <a href='https://github.com/mages-g/End-to-End-ADHD-Smartbot' target='_blank'>GitHub Repository</a></div>", unsafe_allow_html=True)
...
with chat_container:
    ...
    for message in st.session_state.messages:
        if message["role"] == "user":
            ...
            st.markdown(f'<div class="chat-message bot"><div><strong>ADHD Assistant</strong></div><div class="message-content">{content}</div>{source_html}</div>', unsafe_allow_html=True)

# Chat input
if st.session_state.initialized:
    user_input = st.chat_input("Ask a psychiatric question...")
    ...
    if user_input:
        ...
        # Generate response
        with st.spinner("Searching psychiatric literature..."):
            try:
...
# Footer
st.markdown("---")
st.markdown("Powered by Ollama and Pinecone | [GitHub Repository](https://github.com/g-mages/End-to-End-ADHD-Smartbot) | Created by [mages-g](https://github.com/g-mages)")

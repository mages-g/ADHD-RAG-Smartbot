...
def get_qa_prompt():
    ...
    """
    template = """
    You are a knowledgeable psychiatric assistant providing accurate information based on psychiatric literature. 
    ...
    - Use psychiatric terminology appropriately but explain complex terms

...
def get_ollama_llm(
    ...
    """
    Initialize and return an Ollama LLM optimized for psychiatric question answering
    ...
    """
    # Default system prompt for psychiatric question answering if none provided
    if system_prompt is None:
        system_prompt = """You are a psychiatric ADHD assistant providing accurate information based on ADHD literature. Your answers should be factual, precise, and based only on verified medical and literary information. Avoid speculation and clearly indicate when information might be incomplete."""
